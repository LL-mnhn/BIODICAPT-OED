...
![alt text](images/Flowchart-STOC-data.png "Flowchart for BIODICAPT OED replaced by STOC")
...
![alt text](images/Flowchart-STOC-500ENI-data.png "Flowchart for BIODICAPT OED replaced by STOC but applied to 500 ENI")
...
![alt text](images/Flowchart-BIODICAPT-data.png "Flowchart for BIODICAPT OED")
...
![alt text](figure4_ovaskainen_2017.png "HMSC model diagram")
